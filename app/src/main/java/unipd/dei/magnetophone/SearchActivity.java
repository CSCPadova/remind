...
public class SearchActivity extends ListActivity {
    ...
    private Cursor doMySearch(String query) {
        MagnetophoneOpenHelper dbHelper = new MagnetophoneOpenHelper(this);
        SQLiteDatabase db = dbHelper.getReadableDatabase();

        String selection = MagnetophoneOpenHelper.SIGNATURE + " LIKE \"%" + query + "%\"";
        Cursor cursor = db.query(MagnetophoneOpenHelper.SONG, null, selection, null, null, null, null, null);
