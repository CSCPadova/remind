...
import unipd.dei.magnetophone.utility.CustomAdapterList;
...
//		s.setNumberOfTracks(numberOfTracks);
    ...
    private void loadListFromDatabaseAndXml() {
        ...
        DatabaseHelper dbHelper = new DatabaseHelper(SongList.this);
        //invoco il metodo che si occupa di importre i file XML nuovi o modificati
        imp.importazioneXML(this, dbHelper, false);
...
//		String query = "SELECT " + DatabaseHelper.SONGID + " FROM " + DatabaseHelper.SONG + ";";
