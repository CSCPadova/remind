...
public class Song
{
	 ...
	 *            : id della canzone
	 * @param t
	 *            : path della prima traccia, automaticamente impostato su
	 *            indice 1
	 * @param t2
	 *            : path della seconda traccia, automaticamente impostato su
	 *            indice 2
	 * @param t3
	 *            : path della terza traccia, automaticamente impostato su
	 *            indice 3
	 * @param t4
	 *            : path della seconda traccia, automaticamente impostato su
	 *            indice 4
	 ...
	 *            : id della song
	 * @param t
	 *            : prima traccia della song
	 * @param t
	 *            : seconda traccia della song
	 */
	 ...
	 * @param i
	 * @param t1
	 *            : unica traccia (mono o stereo) della song
	 */
	 ...
	 *            path della traccia
	 * @param i
	 *            indice che si desidera far avere alla traccia
	 */
	 ...
	 *            : canzone
	 * @param intent
	 *            : Intent da dare alla canzone per riempirlo dei dati della
	 *            canzone
	 */
